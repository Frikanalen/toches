...
export type ResolversTypes = ResolversObject<{
  ...
  Session: ResolverTypeWrapper<
    DeepPartial<Omit<Session, "user"> & { user?: Maybe<ResolversTypes["User"]> }>
  >
  String: ResolverTypeWrapper<DeepPartial<Scalars["String"]>>
  User: ResolverTypeWrapper<UserWithKeys>
  UserMutationResult: ResolverTypeWrapper<
    DeepPartial<
      Omit<UserMutationResult, "user"> & { user?: Maybe<ResolversTypes["User"]> }
    >
  >
  UserMutations: ResolverTypeWrapper<
    DeepPartial<
      Omit<UserMutations, "login" | "logout" | "register"> & {
        login: ResolversTypes["UserMutationResult"]
        logout: ResolversTypes["UserMutationResult"]
        register: ResolversTypes["UserMutationResult"]
      }
    >
  >
  ...
  VideoMutationPayload: ResolverTypeWrapper<
    DeepPartial<
      Omit<VideoMutationPayload, "video"> & { video?: Maybe<ResolversTypes["Video"]> }
    >
  >
  VideoMutations: ResolverTypeWrapper<
    DeepPartial<
      Omit<VideoMutations, "create" | "delete" | "publish" | "unpublish" | "update"> & {
        create: ResolversTypes["VideoMutationPayload"]
        ...
        update: ResolversTypes["VideoMutationPayload"]
      }
    >
  >
...
export type ResolversParentTypes = ResolversObject<{
  ...
  User: UserWithKeys
  UserMutationResult: DeepPartial<
    Omit<UserMutationResult, "user"> & { user?: Maybe<ResolversParentTypes["User"]> }
  >
  UserMutations: DeepPartial<
    Omit<UserMutations, "login" | "logout" | "register"> & {
      login: ResolversParentTypes["UserMutationResult"]
      logout: ResolversParentTypes["UserMutationResult"]
      register: ResolversParentTypes["UserMutationResult"]
    }
  >
  ...
  VideoMutationError: never
  VideoMutationPayload: DeepPartial<
    Omit<VideoMutationPayload, "video"> & { video?: Maybe<ResolversParentTypes["Video"]> }
  >
  VideoMutations: DeepPartial<
    Omit<VideoMutations, "create" | "delete" | "publish" | "unpublish" | "update"> & {
      create: ResolversParentTypes["VideoMutationPayload"]
      delete: ResolversParentTypes["VideoMutationPayload"]
      publish: ResolversParentTypes["VideoMutationPayload"]
      unpublish: ResolversParentTypes["VideoMutationPayload"]
      update: ResolversParentTypes["VideoMutationPayload"]
    }
  >
  VideoPagination: VideoPaginationWithKeys
}>

export type BulletinResolvers<
  ContextType = TochesContext,
  ParentType extends ResolversParentTypes["Bulletin"] = ResolversParentTypes["Bulletin"],
> = ResolversObject<{
...
export type BulletinPaginationResolvers<
  ContextType = TochesContext,
  ParentType extends ResolversParentTypes["BulletinPagination"] = ResolversParentTypes["BulletinPagination"],
> = ResolversObject<{
...
> = ResolversObject<{
  bulletin?: Resolver<
    ResolversTypes["Bulletin"],
    ParentType,
    ContextType,
    RequireFields<MutationBulletinArgs, "bulletin">
  >
  organization?: Resolver<
    ResolversTypes["Organization"],
    ParentType,
    ContextType,
    RequireFields<MutationOrganizationArgs, "organization">
  >
...
export type OrganizationEditorResolvers<
  ContextType = TochesContext,
  ParentType extends ResolversParentTypes["OrganizationEditor"] = ResolversParentTypes["OrganizationEditor"],
> = ResolversObject<{
...
> = ResolversObject<{
  bulletin?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryBulletinArgs, "id">
  >
  bulletins?: Resolver<
    ResolversTypes["BulletinPagination"],
    ParentType,
    ContextType,
    RequireFields<QueryBulletinsArgs, "page" | "perPage">
  >
  organization?: Resolver<
    ResolversTypes["Organization"],
    ParentType,
  ...
  >
  schedule?: Resolver<
    ResolversTypes["SchedulePagination"],
    ParentType,
    ContextType,
    RequireFields<QueryScheduleArgs, "filter" | "page" | "perPage">
  >
  ...
  >
  videos?: Resolver<
    ResolversTypes["VideoPagination"],
    ParentType,
    ContextType,
    RequireFields<QueryVideosArgs, "page" | "perPage">
  >
}>

export type ScheduleItemResolvers<
  ContextType = TochesContext,
  ParentType extends ResolversParentTypes["ScheduleItem"] = ResolversParentTypes["ScheduleItem"],
> = ResolversObject<{
...
export type SchedulePaginationResolvers<
  ContextType = TochesContext,
  ParentType extends ResolversParentTypes["SchedulePagination"] = ResolversParentTypes["SchedulePagination"],
> = ResolversObject<{
...
export type VideoImagesResolvers<
  ContextType = TochesContext,
  ParentType extends ResolversParentTypes["VideoImages"] = ResolversParentTypes["VideoImages"],
> = ResolversObject<{
...
export type VideoMutationErrorResolvers<
  ContextType = TochesContext,
  ParentType extends ResolversParentTypes["VideoMutationError"] = ResolversParentTypes["VideoMutationError"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<null, ParentType, ContextType>
  message?: Resolver<ResolversTypes["String"], ParentType, ContextType>
}>

export type VideoMutationPayloadResolvers<
  ContextType = TochesContext,
  ParentType extends ResolversParentTypes["VideoMutationPayload"] = ResolversParentTypes["VideoMutationPayload"],
> = ResolversObject<{
...
> = ResolversObject<{
  create?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<VideoMutationsCreateArgs, "input">
  >
  delete?: Resolver<
    ResolversTypes["VideoMutationPayload"],
    ParentType,
    ContextType,
    RequireFields<VideoMutationsDeleteArgs, "videoId">
  >
  publish?: Resolver<
    ResolversTypes["VideoMutationPayload"],
    ParentType,
    ContextType,
    RequireFields<VideoMutationsPublishArgs, "videoId">
  >
  unpublish?: Resolver<
    ResolversTypes["VideoMutationPayload"],
    ParentType,
    ContextType,
    RequireFields<VideoMutationsUnpublishArgs, "videoId">
  >
  update?: Resolver<
    ResolversTypes["VideoMutationPayload"],
    ParentType,
    ContextType,
    RequireFields<VideoMutationsUpdateArgs, "input">
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>

export type VideoPaginationResolvers<
  ContextType = TochesContext,
  ParentType extends ResolversParentTypes["VideoPagination"] = ResolversParentTypes["VideoPagination"],
> = ResolversObject<{
